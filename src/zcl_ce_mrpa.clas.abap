CLASS zcl_ce_mrpa DEFINITION
  ...
  PRIVATE SECTION.
    CLASS-DATA gt_filters TYPE if_rap_query_filter=>tt_name_range_pairs.
ENDCLASS.



CLASS zcl_ce_mrpa IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    ...
    CASE io_request->get_entity_id( ).
      WHEN 'ZCE_MRPA'.
        ...
        READ TABLE lt_filter INTO DATA(ls_filter_plant) WITH KEY name = 'PLANT'.
        IF sy-subrc EQ 0.
            APPEND ls_filter_plant TO gt_filters.
        ENDIF.
